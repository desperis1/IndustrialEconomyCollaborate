...
public class CopperOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("industrial_economy:copper_ore", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.STONE.defaultBlockState()),
						IndustrialEconomyModBlocks.COPPER_ORE.get().defaultBlockState())), 8));
		PLACED_FEATURE = PlacementUtils.register("industrial_economy:copper_ore", CONFIGURED_FEATURE,
