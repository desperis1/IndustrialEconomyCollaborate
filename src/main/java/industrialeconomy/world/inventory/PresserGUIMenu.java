...
public class PresserGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PresserGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(IndustrialEconomyModMenus.PRESSER_GUI.get(), id);
