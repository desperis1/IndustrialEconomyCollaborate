...
public class SteeldiamondguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SteeldiamondguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(IndustrialEconomyModMenus.STEELDIAMONDGUI.get(), id);
