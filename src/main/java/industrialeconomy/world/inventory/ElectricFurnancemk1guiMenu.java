...
public class ElectricFurnancemk1guiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ElectricFurnancemk1guiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(IndustrialEconomyModMenus.ELECTRIC_FURNANCEMK_1GUI.get(), id);
