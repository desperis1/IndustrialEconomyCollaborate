...
public class Constructormk2guiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Constructormk2guiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(IndustrialEconomyModMenus.CONSTRUCTORMK_2GUI.get(), id);
