...
public class ConstructorguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ConstructorguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(IndustrialEconomyModMenus.CONSTRUCTORGUI.get(), id);
