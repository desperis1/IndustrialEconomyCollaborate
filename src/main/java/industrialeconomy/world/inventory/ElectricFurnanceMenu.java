...
public class ElectricFurnanceMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ElectricFurnanceMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(IndustrialEconomyModMenus.ELECTRIC_FURNANCE.get(), id);
