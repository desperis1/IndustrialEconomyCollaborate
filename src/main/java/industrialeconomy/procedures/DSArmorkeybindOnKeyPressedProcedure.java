...
public class DSArmorkeybindOnKeyPressedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY)
				.getItem() == IndustrialEconomyModItems.DIAMOND_STEEL_ARMOR_HELMET.get()
				...
				if (entity instanceof ServerPlayer _ent) {
					...
					NetworkHooks.openScreen((ServerPlayer) _ent, new MenuProvider() {
						...
						public Component getDisplayName() {
							return Component.literal("DiamondSteelArmorGUI");
						}

						@Override
						public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
							return new DiamondSteelArmorGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(_bpos));
						}
					}, _bpos);
				}
			}
