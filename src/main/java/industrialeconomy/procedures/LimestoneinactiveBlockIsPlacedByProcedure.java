...
public class LimestoneinactiveBlockIsPlacedByProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((world.getBlockState(new BlockPos(x, y - 1, z))).getBlock() == Blocks.DIRT
			...
			world.setBlock(new BlockPos(x, y - 1, z), IndustrialEconomyModBlocks.LIMESTONEINACTIVE.get().defaultBlockState(), 3);
			world.setBlock(new BlockPos(x - 1, y - 1, z), Blocks.SANDSTONE.defaultBlockState(), 3);
			world.setBlock(new BlockPos(x + 1, y - 1, z), Blocks.SANDSTONE.defaultBlockState(), 3);
			world.setBlock(new BlockPos(x, y - 1, z - 1), Blocks.SANDSTONE.defaultBlockState(), 3);
			world.setBlock(new BlockPos(x, y - 1, z + 1), Blocks.SANDSTONE.defaultBlockState(), 3);
		} else {
			world.setBlock(new BlockPos(x, y, z), Blocks.AIR.defaultBlockState(), 3);
			if (new Object() {
				...
				if (world instanceof Level _level && !_level.isClientSide()) {
					ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(IndustrialEconomyModBlocks.LIMESTONEINACTIVE.get()));
