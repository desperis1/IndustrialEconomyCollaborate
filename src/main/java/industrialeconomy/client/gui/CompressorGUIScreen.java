...
public class CompressorGUIScreen extends AbstractContainerScreen<CompressorGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("industrial_economy:textures/screens/compressor_gui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Compressor", 62, 4, -12829636);
		this.font.draw(poseStack, "10 000 MW", 124, 4, -12829636);
	}
