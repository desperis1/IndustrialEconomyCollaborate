...
public abstract class SpaceSuitItem extends ArmorItem {
	public SpaceSuitItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends SpaceSuitItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "industrial_economy:textures/models/armor/spacesuit_layer_1.png";
		}
	}
	...
	public static class Leggings extends SpaceSuitItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "industrial_economy:textures/models/armor/spacesuit_layer_2.png";
		}
	}
